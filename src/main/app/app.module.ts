...
import {
  KeepDropdownMenuComponent
} from "../keep-container/keep-content/keep-dropdown-menu/keep-dropdown-menu.component";

import { KeepFooterNoteComponent } from "../keep-container/keep-content/keep-footer-note/keep-footer-note.component";
...
@NgModule({
  ...
  providers: [NoteService, HeaderService, KeepCommonNoteComponent, LabelService, FooterService],
